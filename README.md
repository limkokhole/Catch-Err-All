...
### Sample of use case:
 ...
 Grammar check ("bigger than", not "bigger then", lol) (-v means normal log, if you expect to see warning then either: my bug OR uncommon keywords OR non-warning keywords OR typo OR bad grammar):   
